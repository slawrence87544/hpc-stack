...
[[ -z $mpi ]] || extra_conf="--enable-parallel --enable-unsupported --enable-build-mode=production --enable-static"

[[ $enable_shared =~ [yYtT] ]] && shared_flags="--enable-shared" || shared_flags="--disable-shared --enable-static-exec"
